...
public class FragUtils {
    public static String Tag_Current_Frag = "CurrentFrag";
    private FragmentManager fm;
    private String currentFragTag = "-1";
    private String currentFragTagInstance = "-1";
    ...
    public FragUtils checkState(Bundle savedInstanceState) {
        isExist = (savedInstanceState != null);
//        if (isExist) {
//            currentFragTagInstance = (String) savedInstanceState.get(Tag_Current_Frag);
//        }
        return this;
    }

    public Bundle saveInstanceState(Bundle outState) {
        outState.putString(Tag_Current_Frag, currentFragTag);
        return outState;
    }
    ...
    public void showFragment(String fragtag) {
        ...
        if (prefragtag.equals("-1")) {
            ...
            if (isExist) {
                Fragment tempFragment = fm.findFragmentByTag(fragtag);
                fm.beginTransaction()
                        .replace(containerViewId, tempFragment, fragtag).commit();
            } else {
                fm.beginTransaction()
