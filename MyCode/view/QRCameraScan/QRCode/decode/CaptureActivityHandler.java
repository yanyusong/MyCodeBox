...
package net.aibianli.qrcodescanner.supports.QRCode.decode;
...
import net.aibianli.qrcodescanner.R;
import net.aibianli.qrcodescanner.supports.QRCode.camera.CameraManager;
import net.aibianli.qrcodescanner.modules.Scanner.CaptureActivity;
import net.aibianli.qrcodescanner.supports.QRCode.view.ViewfinderResultPointCallback;
