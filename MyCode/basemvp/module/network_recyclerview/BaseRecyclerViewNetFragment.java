package cn.aibianli.sdot.base.module.network_recyclerview;
...
import cn.aibianli.sdot.base.adapter.multirecycler.ItemEntityList;
import cn.aibianli.sdot.base.adapter.multirecycler.MultiRecyclerAdapter;
import cn.aibianli.sdot.base.adapter.multirecycler.OnBind;
import cn.aibianli.sdot.base.module.network.BaseNetFragment;
import cn.aibianli.sdot.common.widgets.DividerGridItemDecoration;
...
public abstract class BaseRecyclerViewNetFragment<T extends BasePageContract.IBaseRecyclerViewPresenter> extends BaseNetFragment<T> implements BasePageContract.IBaseRecyclerView<T>, SwipeRefreshLayout.OnRefreshListener {
    ...
    private View initView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (divider == null) {
            itemDecoration = new DividerGridItemDecoration(ct, 1, 0xffc7c7cd) {
                @Override
