package cn.aibianli.sdot.common.widgets.materialsheetfab.animations;
...
import cn.aibianli.sdot.common.widgets.materialsheetfab.MaterialSheetFab;
import cn.aibianli.sdot.common.widgets.materialsheetfab.MaterialSheetFab.RevealXDirection;
import cn.aibianli.sdot.common.widgets.materialsheetfab.MaterialSheetFab.RevealYDirection;
...
public class MaterialSheetAnimation {
    ...
    public void alignSheetWithFab(View fab) {
        ...
        //居中对齐,减1,方便适配RevealXDirection
        sheet.setX(fab.getX() - (sheet.getWidth() - fab.getWidth()) / 2 - 1);
        revealXDirection = RevealXDirection.LEFT;
    ...
    protected void startCircularRevealAnim(View view, int centerX, int centerY, float startRadius,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            // Setup animation
            SupportAnimator anim = cn.aibianli.sdot.common.widgets.io.codetail.animation.ViewAnimationUtils
